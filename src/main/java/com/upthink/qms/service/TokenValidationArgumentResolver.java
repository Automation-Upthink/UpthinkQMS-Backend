...
public class TokenValidationArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
        ...
        System.out.println("Resolver accessed to *******************************");
        ...
        System.out.println("Resolver " + authentication.getCredentials());
        if (authentication != null && authentication.getCredentials() instanceof TokenValidation) {
            ...
            System.out.println("Token validation object in resolver: " + tokenValidation);
