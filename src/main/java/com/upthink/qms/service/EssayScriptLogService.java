...
public class EssayScriptLogService {
    ...
    public void insertScriptLog(
        ...
        essayScriptLogRepository.insertScriptLog(personId, actionPerformed, type, clientName, uuid);
    }
    ...
    public List<EssayScriptLogResponse.EssayScriptLogDTO> getLatestScriptLog(
        ...
        System.out.println("time diff " + minutesDifference);
