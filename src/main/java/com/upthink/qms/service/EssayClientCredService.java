...
public class EssayClientCredService {
    ...
    @Transactional
    public EssayClientCred createEssayClientCredential(String name, String password, String clientName, int downloadLimit, String emailId) {
        ...
        essayClientCredRepository.save(essayClientCred);
        return essayClientCred;
    }
    ...
    public int deleteEssayClientCredential(int id) {
        EssayClientCred essayClientCred = essayClientCredRepository.deleteEssayClientCred(id);
        int clientCredId = essayClientCred.getId();
        return clientCredId;
    }
    ...
    public EssayClientCredResponse listClientCredsForAClient(String clientName) {
        Optional<EssayClient> essayClient = essayClientRepository.findByName(clientName);
        int clientId = essayClient.get().getId();
    ...
    public EssayClientCredResponse listClientCreds(){
        ...
        List<EssayClientCredResponse.EssayClientCredDTO> essayClientCredDTOList = essayClientCredList.stream()
                .map(essayClientCred ->
                    {
                        return new EssayClientCredResponse.EssayClientCredDTO(
